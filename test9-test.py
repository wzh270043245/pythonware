...
class Window2(QWidget,Ui_Form2):
    ...
    def __init__(self):
        ...
        self.groupBox2.setParent (self)
        self.groupBox3.setParent (self)
        self.groupBox4.setParent (self)
        self.groupBox2.move (1036,222)
        self.groupBox3.move (1036,472)
        self.groupBox4.move (1323,222)
